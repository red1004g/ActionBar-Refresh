...
package com.ko.classting.library.refresh;
...
import com.ko.classting.R;
import com.ko.classting.library.smoothprogressbar.SmoothProgressBar;
import com.ko.classting.library.smoothprogressbar.SmoothProgressDrawable;
import com.ko.classting.library.refresh.sdk.Compat;
...
public class DefaultHeaderTransformer extends HeaderTransformer {
    ...
    public boolean hideHeaderView() {
        ...
        if (changeVis && Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            Animator animator;
